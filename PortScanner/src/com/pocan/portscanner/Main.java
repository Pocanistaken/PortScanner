...
public class Main extends FileModule{
    ...
    public static void main(String[] args) {
        System.out.println(TEXT_CYAN + "Multithreaded PortScanner 1.0 by Pocan");
        System.out.println(TEXT_CYAN + "Join my discord server https://discord.gg/D4bqSty ");
     
        Scanner scan = new Scanner(System.in);
        scan.useLocale(Locale.US);
        System.out.println(TEXT_YELLOW + "Please write ip address." + TEXT_RESET);
        String ipAddress = scan.nextLine();    
        System.out.println(TEXT_YELLOW + "Please write start port." + TEXT_RESET);
        int startPort = scan.nextInt();    
        System.out.println(TEXT_YELLOW + "Please write end port." + TEXT_RESET);
        int endPort = scan.nextInt();   
        System.out.println(TEXT_YELLOW + "Please write check second (Example: 1 (1/1000 seconds))." + TEXT_RESET);
